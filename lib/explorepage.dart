...
class _ExplorepageState extends State<Explorepage> {
  ...
  Future<void> loadTutorsServices()async{
    ...
    print('serviceId: ${fetchedServices[0].serviceId}');
    print('tutorId: ${fetchedServices[0].tutorId}');
    final teacherservice =
        await Explore_service().getTutorsFromServices(fetchedServices);
    setState(() {
      tutors = teachers;
      allTutors = teachers;
                    ...
                    itemBuilder: (context,index){
                      return Padding(
                        ...
                        child: SizedBox(
                          ...
                          autofocus: true,
                          dropdownColor: Colors.white,
                          focusColor: const Color(0xFF000080),
                          decoration: InputDecoration(
                            filled: true,
    ...
    setState(() {
      services = allServices.where((s) {
        ...
        final matchPrice = selectedPrice == null ||
            s.price <=
                double.parse(selectedPrice!.replaceAll('<', ''));
