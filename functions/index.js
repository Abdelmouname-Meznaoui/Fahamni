...
// ── Send Welcome Email ────────────────────────────────────────────────────────
exports.sendWelcomeEmail = onCall({ allowUnauthenticated: true }, async (request) => {
...
exports.sendPasswordChangedEmail = onCall({ allowUnauthenticated: true }, async (request) => {
